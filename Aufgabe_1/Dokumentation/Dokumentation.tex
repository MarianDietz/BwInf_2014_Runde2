...
Wie schon beschrieben, wird bei jeder Beobachtung das für diese Beobachtung beste Feld zum Löschen ausgewählt. Der Algorithmus ist also ein \emph{gieriger Algorithmus}. Es gilt also zu zeigen, dass insgesamt nicht weniger Felder abbrennen, sollte bei einer Beobachtung nicht das für diese Beobachtung optimalste Feld gelöscht werden.\\
